import { ADD_TODO, REMOVE_TODO, SET_NAME, SET_NOTE, SET_DESCRIPTION, SET_COMPLETED, PIN_TO_TOP, UNPIN, IS_MODIFY_TRUE, IS_MODIFY_FALSE } from '../types'
...
const unpinTodo = (pinned, todos) => dispatch => {
    todos.unshift(pinned[0])
    dispatch({
        type: UNPIN,
        payload: [...todos]
    })
